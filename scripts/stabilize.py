...
Usage:
    ...
    python3 scripts/stabilize.py one-pager resume-en --out-dir /tmp/folio-stabilized --report
...
def count_pages(html: str, base_dir: Path) -> int:
    ...
    try:
        with tempfile.NamedTemporaryFile(prefix="folio-stabilize-", suffix=".pdf", delete=False) as tmp:
...
def build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Stabilize Folio HTML templates.")
