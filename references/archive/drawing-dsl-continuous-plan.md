...
Detailed evidence is in `drawing-dsl-v3-4-audit.md`; release notes are in `../../docs/releases/RELEASE_NOTES_V3.4.md`.
...
Detailed evidence is in `drawing-dsl-v4-0-audit.md`; release notes are in `../../docs/releases/RELEASE_NOTES_V4.0.md`.
...
Detailed evidence is in `drawing-dsl-v4-1-audit.md`; release notes are in `../../docs/releases/RELEASE_NOTES_V4.1.md`.
...
Detailed evidence is in `drawing-dsl-v4-2-audit.md`; release notes are in `../../docs/releases/RELEASE_NOTES_V4.2.md`.
...
Detailed evidence is in `drawing-dsl-v4-3-audit.md`; release notes are in `../../docs/releases/RELEASE_NOTES_V4.3.md`.
