...
The legacy V2 type scope is documented in `drawing-dsl-v2-plan.md`. The completed V3 release train and final acceptance contract are documented in `drawing-dsl-v3-plan.md` and `drawing-dsl-v3-completion-goal.md`. Post-V3 stabilization and the continuous V4 release train are tracked in `drawing-dsl-continuous-plan.md`. The V5 acceptance record is `drawing-dsl-v5-final-audit.md`, and the closing program audit, including reference-principle conformance, the 22-kind showcase visual pass, and remaining limits, is `drawing-dsl-v6-final-audit.md`.
