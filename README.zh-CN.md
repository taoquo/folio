...
| 类型 | 适合场景 | Demo |
|---|---|---|
| One-Pager | 上线简介、提案、执行摘要 | [demo-orbit-onepager.pdf](assets/demos/demo-orbit-onepager.pdf) |
| Long Doc | 白皮书、复盘、技术报告 | [demo-agent-ops-longdoc.pdf](assets/demos/demo-agent-ops-longdoc.pdf) |
| Letter | 正式信件、备忘录、声明 | [demo-board-letter.pdf](assets/demos/demo-board-letter.pdf) |
| Portfolio | 作品集、案例集、精选项目 | [demo-ridge-portfolio.pdf](assets/demos/demo-ridge-portfolio.pdf) |
| Resume | 简历、职业履历 | [demo-musk-resume.pdf](assets/demos/demo-musk-resume.pdf) |
| Slides | 演讲稿、Keynote、内部汇报 | [demo-agent-slides.pdf](assets/demos/demo-agent-slides.pdf) |
| Equity Report | 投资备忘录、财报快报、个股研报 | [demo-tesla.pdf](assets/demos/demo-tesla.pdf) |
| Changelog | 更新日志、版本说明、Release Notes | [demo-folio-changelog.pdf](assets/demos/demo-folio-changelog.pdf) |

模板位于 `assets/templates/`。上面每一类都已经配好真实 demo 资产，包含可点击 PDF、对应 HTML 源文件和 PNG 预览图。
...
示例在 `assets/illustrations/`：

- Tesla Optimus 专利示意总览
- SpatialVLA 架构重绘
- 3D 表示取舍图
...
- 代码和模板使用 MIT License。
- LXGW WenKai 为开源字体；Charter 和 CJK fallback 依赖系统或开源可用性。
